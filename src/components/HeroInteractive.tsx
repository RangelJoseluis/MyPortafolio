      ...
      <div className="relative flex flex-col gap-3 md:gap-4 max-w-3xl w-full items-center justify-center text-center mb-8 z-10">
        ...
        <div className="flex flex-col items-center gap-2 md:gap-3">
          ...
          <div className="flex gap-3 md:gap-4 mt-1">
            <a href="https://www.facebook.com/joseluis.riverarangel.71?locale=es_LA" target="_blank" rel="noopener noreferrer" className="w-10 h-10 md:w-11 md:h-11 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110" title="Facebook">
            ...
            <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 md:w-11 md:h-11 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110" title="Twitter">
            ...
            <a href="https://linkedin.com/in/joseluisrangelperez" target="_blank" rel="noopener noreferrer" className="w-10 h-10 md:w-11 md:h-11 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110" title="LinkedIn">
            ...
            <a href="https://github.com/RangelJoseluis" target="_blank" rel="noopener noreferrer" className="w-10 h-10 md:w-11 md:h-11 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110" title="GitHub">
